...
public class User {
    ...
    @Column(name = "creaete_date", nullable = false)
    @CreationTimestamp
    ...
    @JoinColumn(name = "role_id", foreignKey = @ForeignKey(name = "fk_role_id_user"), nullable = false)
    @JsonIgnore
    private Role role;

    public User(String userId, String name, String password, String fullname,
